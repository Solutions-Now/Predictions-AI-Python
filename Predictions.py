...
class Predictions:
    ...
    def train_model(self):
        ...
        print(f'self.X_val.shape: {self.X_val.shape}')
        print(f'self.y_val.shape: {self.y_val.shape}')
        ...
        # Train the model
        model1.fit(self.X_train, self.y_train, epochs=5, validation_data=(self.X_val, self.y_val), callbacks=[cp, es])
